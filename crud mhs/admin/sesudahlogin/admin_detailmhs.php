...
<body>
    ...
    <section id="mhs">
        <div class="container">
            <form action="admin_tambahmhs.php">
                            ...
                            <?php
                                if (mysqli_num_rows($result) > 0){
                                    while ($row = mysqli_fetch_assoc($result)){
                                        ...
                                        echo "<th style='font-weight:400'>" . $row['nrp']. "</th>";
                                        echo "<th style='font-weight:400'>" . $row['nama_depan']. "&nbsp".$row['nama_belakang']. "</th>";
                                        echo "<th style='font-weight:400'>".$row['jurusan']. "</th>";
                                        echo "<th style='font-weight:400'>".$row['jenis_kelamin']. "</th>";
                                        echo "<th style='font-weight:400'>".$row['username']. "</th>";
                                        echo "<th><a href='admin_mhsprofil.php?id=$row[id]'><i class='fas fa-info-circle' style='color:green;'></i></a>&nbsp 
                                        <a href='admin_updatemhs.php?id=$row[id]'><i class='fas fa-pencil-alt'></i></a> &nbsp 
                                        <a href='admin_deletemhs2.php?id=$row[id]'><i class='fas fa-trash-alt'style='color:red;'></i></a></th>";
                                        echo "</tr>";
                                    }
                                }else{
                                    ?>
