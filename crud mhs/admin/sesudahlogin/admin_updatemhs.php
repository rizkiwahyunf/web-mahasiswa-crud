    ...
    ?>
        ...
        <div class="container">
                    <div class="card shadow-lg border-0 mt-4">
                        ...
                        <div class="card-body">
                            <form action="admin_updatemhs2.php?id=<?php echo "$id"?>" method="post"  enctype="multipart/form-data">                                
                            <div class="form-group">
                                    <input type="number" class="form-control" id="nrp" name="nrp" value="<?php echo $nrp;?>">
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <input type="number" class="form-control" id="nohp" name="nohp" value="<?php echo $nrp;?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
