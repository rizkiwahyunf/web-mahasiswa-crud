        ...
        <div class="container">
                    <div class="card shadow-lg border-0 mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="admin_register2.php" method="post"  enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group form-check float-left">
                                            ...
                                            <label for="checkbox1">I agree the Terms and Conditions</label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="akun form-group float-right">
