<?php
    ...
    header('location: ../sebelumlogin/dosen_login.php');
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <!--css eksternal-->
    <link rel="stylesheet" href="css/dosen_halaman.css">
    <!--fontawesome-->
        ...
        <div class="container">
            <div class="side">
                <div class="profile text-center">
                    <?php echo "<img src='../../profile/dosen/". $row['foto']."' class='card-img-top'>";
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="one">
                            ...
                            <div id="collapseOne" class="collapse" data-parent="#accordionExample">
                                <a href="dosen_uploadtugas.php">Upload Tugas</a> 
                                <a href="dosen_uploadnilai.php">Beri Nilai</a> </div>
                        </div>
                        <div class="two">
                            <h2 class="mb-0">
                        ...
                        <div class="log">
                            <i class="fas fa-arrow-circle-left"></i><a href="dosen_uploadnilai.php" >Logout</a>
                        </div>
                        <div class="log">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">NIP <span style="margin-left:160px"><?php echo $row['nip']?></span></li>
                                ...
                                <li class="list-group-item">Pendidikan Terakhir <span style="margin-left:30px"><?php echo $row['study_terakhir']?></span></li>
